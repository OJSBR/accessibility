...
/**
 * @file plugins/blocks/accessibility/tests/run.php
 *
...
define('ACCESSIBILITY_STANDALONE_TESTS', true);
...
foreach ($files as $file) {
    require_once $file;
    $class = 'APP\\plugins\\blocks\\accessibility\\tests\\' . basename($file, '.php');
